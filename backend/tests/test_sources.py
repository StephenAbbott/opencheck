...
_IDENTIFIER_KEYED = {"eiti", "ariregister", "bolagsverket", "cnpj_brazil", "cvr_denmark", "firmenbuch", "krs_poland", "malta_mbr", "nz_companies", "opencorporates", "inpi", "kvk", "rpo_slovakia", "sudreg_croatia", "wikirate", "zefix"}
