...
**Latest: Phase 86** — followthemoney 4.x: the dependency ceiling on rigour lifts
...
**Previous: Phase 85** — rigour Phases B–E: one name normaliser, org-type merge keys, shared scoring, languages
