...
**Latest: Phase 82** — BackgroundCheck: risk checks on the people connected to an entity
...
**Previous: Phase 81** — RDF export: BODS as linked open data, with licensing that travels with the data
...
*Earlier: [Phase 80 — Hotfix: BigQuery GQL export 500 on real data](docs/status.md)*
