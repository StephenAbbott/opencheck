...
**Latest: Phase 98** — Sanctions: telling an ownership chain apart from a handshake
...
**Previous: Phase 97** — OpenAleph graph screening: every related party checked in two percolation calls
...
*Earlier: [Phase 96 — OpenAleph text-based percolation](docs/status.md), and everything before it.*
