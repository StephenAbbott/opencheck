...
**Latest: Phase 100** — `statementDate` from the register's own declaration date
...
**Previous: Phase 99** — Declared source liveness: three clocks, not one call to `date.today()`
...
*Earlier: [Phase 98 — sanction.control vs sanction.linked](docs/status.md), and everything before it.*
