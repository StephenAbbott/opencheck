...
Twenty-five active adapters (plus one bulk-data adapter activated via env var), each implementing the same `SourceAdapter` protocol (`search`, `fetch`, `info`):
