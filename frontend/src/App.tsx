      ...
      >
        ...
        <div className="mb-3">
          ...
          <p className="text-[13px] sm:text-sm text-oo-muted leading-snug mt-2">
            With a Legal Entity Identifier, OpenCheck pulls open corporate data from 38 sources into one graph using the Beneficial Ownership Data Standard
          </p>
        </div>
        {!streamingLei && (
...
const HOW_IT_WORKS_STEPS = [
  ...
  },
  {
    ...
    title: "38 open sources, in parallel",
    body: (
      <>
